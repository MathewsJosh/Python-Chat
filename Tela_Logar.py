...
class loginWindow():
  ...
  def entrarTela(self):
    ...
    self.loginJanela = Tk()
    self.loginJanela.title("Entre para usar o Chattttô!")
    ...
    self.camLoginButton = PhotoImage(file="Icones\Botoes\Login.png", master=self.loginJanela)
    ...
    self.botaoEntrar = Button(self.loginJanela, text="Entrar", command=self.logarMetodo, image=self.camLoginButton, bd=0, relief=GROOVE)
