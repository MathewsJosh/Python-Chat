...
class cadastrarWindow():
    ...
    def cadastrarTela(self):
        ...
        self.cadastrarJanela.title("Cadastre-se no Chattttô!")
        ...
        self.camCadastrarButton = PhotoImage(file="Icones\Botoes\Cadastrar.png", master=self.cadastrarJanela)
        self.camVoltarButton = PhotoImage(file="Icones\Botoes\Voltar.png", master=self.cadastrarJanela)
